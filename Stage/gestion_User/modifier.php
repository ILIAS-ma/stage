...
<body>
    <div class="container">
        ...
        <h1>Modifier les joueurs <?php echo date('d/m/Y', strtotime($menu['date_menu'])); ?></h1>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="date" id="date_menu" name="date_menu" value="<?php echo $menu['date_menu']; ?>"
                        required>
                </div>

                <div class="form-group">
                    <label for="entree">Entrée</label>
                    <input type="text" id="entree" name="entree" value="<?php echo $entree; ?>"
                        placeholder="Ex: Salade de tomates">
                </div>

                <div class="form-group">
                    <label for="plat">Plat principal</label>
                    <input type="text" id="plat" name="plat" value="<?php echo $plat; ?>"
                        placeholder="Ex: Poulet rôti et pommes de terre">
                </div>

                <div class="form-group">
                    <label for="dessert">Dessert</label>
                    <input type="text" id="dessert" name="dessert" value="<?php echo $dessert; ?>"
